      ...
      items: [
        {
          ...
          github: "https://github.com/khalilamir99/Portofolio-Khalil",
          demo: "null",
        },
        {
          id: 2,
          name: "Mail Management Application",
          imageUrl: "surat",
          status:
            "A website functions to manage incoming and outgoing mail to make it easier and more structured.",
          tech: "PHP, MaterializeCSS",
          github:
            "https://github.com/khalilamir99/Incoming-and-Outgoing-Mail-Management-Application",
          demo: "null",
        },
        {
          id: 3,
          ...
          imageUrl: "spk",
          status:
            "Decision Support System to Determine the Best Camping Tent Rental Shop using MAUT method",
          tech: "CodeIgniter 3, Bootstrap",
          github:
            "https://github.com/khalilamir99/Decision-Support-System-to-Determine-the-Best-Camping-Tent-Rental-Shop",
          demo: "null",
        },
        {
          id: 4,
          name: "Digitized Building Mapping",
          imageUrl: "gis",
          status:
            "Web GIS Application for Digitized Building Mapping at Andalas University.",
          tech: "MapInfo, PHP",
          github: "null",
          demo: "null",
        },
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      ...
      <section>
        <div>
          <div
            class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-2 md:gap-3 xl:grid-cols-2 xl:gap-3 2xl:gap-5 fade-zoom-in"
          >
              ...
              >
                ...
                >
                  <img
                    ...
                    :src="'/img/portofolio_' + item.imageUrl + '.png'"
                  />
                </div>
                <div
