    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: "Codeigniter",
          imageUrl: "https://static.cdnlogo.com/logos/c/46/codeigniter.svg",
          status: "Intermediate",
        },
        {
          id: 7,
      ...
      tools: [
        ...
        },
        {
          ...
          name: "Draw.io",
          imageUrl:
            "https://upload.wikimedia.org/wikipedia/commons/3/3e/Diagrams.net_Logo.svg",
      ...
      >
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; An Information Systems graduate with a strong
            interest in systems analysis and software engineering. An
            information technology enthusiast with strong proficiency in both
            hardware and software, including mobile technologies. Experienced in
            designing, analyzing, and developing web-based applications with a
            user-oriented and business-driven approach. Skilled in data analysis
            and business strategy to support effective decision-making. Actively
            involved in various organizational roles during academic years,
            enhancing leadership, communication, and teamwork abilities. Ready
            to apply a combination of technical, analytical, and organizational
            experience to contribute effectively in a dynamic and
